...
- [ ] **NEW:** Selected card visual highlight implementation (AC: 19)
...
- [ ] **NEW:** Notes description preview formatting (AC: 20)
  - [ ] Parse note content to detect list formatting (bulleted vs numbered)
  - [ ] Display appropriate list markers (• for bullets, 1. for numbers) in notes column preview
