...
**Figma Design:** [Notebook and Page Management UI](https://www.figma.com/design/J4Dsi0o3FCgCgqrvPCAehY/Biblion?node-id=0-1&p=f&t=6osUQ9gD76WgcjJk-0)
...
- Selected card must have a distinct style: yellow left border and subtle grey background to indicate selection
...
19. **NEW:** Selected card visual highlight matches design (yellow left border, grey background)
20. **NEW:** Notes column description preview reflects selected list formatting (bulleted or numbered)
...
- [x] **NEW:** Selected card visual highlight implementation (AC: 19)
  - [x] Implement yellow left border (2-3px width) for selected notebook cards
  - [x] Add subtle grey background (#F5F5F5 or similar) for selected notebook cards
  - [x] Implement yellow left border and grey background for selected note cards
  - [x] Ensure visual consistency across all selectable cards in the interface
  - [x] Add smooth transition animations for selection state changes
  - [x] Test selection states across different screen sizes and themes
- [x] **NEW:** Notes description preview formatting (AC: 20)
  - [x] Parse note content to detect list formatting (bulleted vs numbered)
  - [x] Display appropriate list markers (• for bullets, 1. for numbers) in notes column preview
  - [x] Handle mixed content with multiple list types appropriately
  - [x] Implement fallback display for non-list content in description preview
  - [x] Add truncation for long descriptions with ellipsis
  - [x] Ensure preview formatting updates when note content changes
...
- **Design Implementation Notes:**
  ...
  - Selected card must show a yellow left border and subtle grey background, consistent with the design reference
  ...
  - Notes column description preview should display list markers (• or 1.) according to applied formatting
...
- **UI/UX Testing:**
  ...
  - Verify selected card highlight: yellow left border and grey background
  - Confirm notes description preview renders bullets vs numbers based on formatting
...
- ✅ Selected card visual highlight with yellow left border (3px) and grey background (#F5F5F5)
- ✅ Smooth transition animations for selection state changes
- ✅ Notes description preview formatting with list markers (• for bullets, 1. for numbers)
- ✅ Mixed content handling for notes with multiple list types
- ✅ Truncation for long descriptions with ellipsis
- ✅ Monospace font for better list formatting display
...
- `src/utils/notePreviewFormatter.ts` - New utility for formatting note previews with list markers
- `src/app/theme.ts` - Fixed syntax error and updated theme configuration
...
| 2025-01-27 | 0.5     | Completed selected card visual highlight and notes preview formatting           | Developer       |
